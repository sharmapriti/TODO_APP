...
public class EditItemActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText editText1 = (EditText) findViewById(R.id.showDate);
        final EditText editText = (EditText) findViewById(R.id.editTask);
        String text = getIntent().getStringExtra("ListItem");
